...
<!-- Latest jquery -->
 ...
 <!-- Feather icon js -->
 <script src="<?php echo e(asset('frontend/js/feather-icon/feather.min.js')); ?>"></script>
 <script src="<?php echo e(asset('frontend/js/feather-icon/feather-icon.js')); ?>"></script>
 ...
 <!-- Select2 Js-->
 <script src="<?php echo e(asset('frontend/js/select2.full.min.js')); ?>"></script>
 ...
 <script src="<?php echo e(asset('frontend/js/jquery-validation/jquery-validate.js')); ?>"></script>
 <script src="<?php echo e(asset('frontend/js/jquery-validation/jquery-validate.min.js')); ?>"></script>
 <script src="<?php echo e(asset('frontend/js/jquery-validation/additional-methods.js')); ?>"></script>
 <script src="<?php echo e(asset('frontend/js/jquery-validation/additional-methods.min.js')); ?>"></script>
 ...
 <!-- Emoji js -->
 <script src="<?php echo e(asset('frontend/js/emoji-rate.js')); ?>"></script>

 <!-- Plus minus js -->
 <script src="<?php echo e(asset('frontend/js/plus-minus.js')); ?>"></script>

 <!-- Slick slider js -->
 <script src="<?php echo e(asset('frontend/js/slick.min.js')); ?>"></script>
 <script src="<?php echo e(asset('frontend/js/slick-slider.js')); ?>"></script>

 <!-- Lodaz js -->
 <script src="<?php echo e(asset('frontend/js/lodaz/lozad.min.js')); ?>"></script>
 ...
 <script>
     ...
     // Location checking
     $.ajax({
         url: "<?php echo e(url('check-zone')); ?>",
         method: 'GET',
         success: function(data) {
             if (!data.zoneSet) {
                toastr.error("<?php echo e(__('frontend::static.location_error_message')); ?>");
             } else {
                 $('#overlay').hide();
     ...
     function showPosition(position) {
         ...
         $.ajax({
             url:  "<?php echo e(url('get-address')); ?>",
             method: 'GET',
             data: {
                 lat: latitude,
                 lng: longitude
     ...
     $('#locationSearchInput').on('input', function() {
         ...
         if (value.length > 2) {
             ...
             $.ajax({
                 url: "<?php echo e(url('google-autocomplete')); ?>",
                 method: 'GET',
                 data: {
                     location: value
                 },
     ...
     $('#location-list').on('click', '.location', function() {
         ...
         $('#location').html(`<i class="iconsax" icon-name="location"></i><span>${address}</span>`);
         $.ajax({
             url: "<?php echo e(url('get-coordinates')); ?>",
             method: 'GET',
             data: {
                 place_id: placeId
             },
...
<?php /**PATH /Users/apple/Downloads/codecanyon-pL2BDeFh-fixit-multi-vendor-on-demand-handyman-home-service-flutter-app-with-admin-complete-solution/fixit_laravel1/resources/views/frontend/layout/script.blade.php ENDPATH**/ ?>