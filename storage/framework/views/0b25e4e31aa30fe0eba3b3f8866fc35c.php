...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('frontend/images/favicon/1.png')); ?>" type="image/x-icon" />
    ...
    <!-- Swiper Slider css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend/css/vendors/swiper-bundle.min.css')); ?>" />
...
<body class="notLoaded">
    ...
    <div class="page-loader" id="loader">
        <div class="page-loader-wrapper">
            <img src="<?php echo e(asset('frontend/images/gif/loader.gif')); ?>" alt="" />
        </div>
    </div>
    <!-- Loader Section End -->
    ...
    <div class="error-wrapper">
        <div class="no-data-content">
            <img src="<?php echo e(asset('frontend/images/no-data.png')); ?>" alt="no-data" class="img-fluid" />

            <h2>Page Not Found</h2>
            <p>The page you’re trying to find either doesn’t exist or has been relocated.</p>
            <a href="<?php echo e(route('frontend.home')); ?>" class="btn btn-solid">
    ...
    <!-- Favourite js -->
    <script src="<?php echo e(asset('frontend/js/add-favourite.js')); ?>"></script>
...
<?php /**PATH /Users/apple/Downloads/codecanyon-pL2BDeFh-fixit-multi-vendor-on-demand-handyman-home-service-flutter-app-with-admin-complete-solution/fixit_laravel1/resources/views/errors/404.blade.php ENDPATH**/ ?>