...
return [
  ...
  "enableToFeature" => "Aktiviere diese Funktion, um diesen Service auf dem Startbildschirm der Benutzer-App anzuzeigen. Deaktiviere, um ihn zu entfernen.",
  "yourTextHere" => "Dein Text hier...",
  "minutes" => "Minuten",
  "standOutBeSeen" => "Heben Sie sich ab und werden Sie gesehen!",
  "boostNowSeeYourBusinessGrow" => "Jetzt durchstarten und Ihr Unternehmen wachsen sehen!",
